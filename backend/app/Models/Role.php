...
#[OA\Schema(
    schema: 'Role',
    properties: [
        new OA\Property(property: 'id', type: 'integer', format: 'int64', description: 'ロールID'),
        new OA\Property(property: 'name', type: 'string', description: 'ロール識別子'),
        new OA\Property(property: 'display_name', type: 'string', description: '表示名'),
        new OA\Property(property: 'description', type: 'string', nullable: true, description: 'ロールの説明'),
